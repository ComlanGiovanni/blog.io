...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{FF10E1CB-E2FD-C8C1-44C7-8167175ABBB1}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\giova\.node-gyp\6.6.0\include\node;C:\Users\giova\.node-gyp\6.6.0\src;C:\Users\giova\.node-gyp\6.6.0\deps\uv\include;C:\Users\giova\.node-gyp\6.6.0\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\giova\.node-gyp\6.6.0\$(Configuration)\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <ClCompile Include="D:\Bureau\nodejs\blog.io\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;D:\Bureau\nodejs\blog.io\node_modules\bcrypt\lib\binding&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;D:\Bureau\nodejs\blog.io\node_modules\bcrypt\lib\binding\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to D:/Bureau/nodejs/blog.io/node_modules/bcrypt/lib/binding\bcrypt_lib.node</Message>
      <Outputs>D:\Bureau\nodejs\blog.io\node_modules\bcrypt\lib\binding\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{39B2155D-87C4-4CD3-6572-048EB46AF2C2}</Project>
